...
async function checkIpOnEnable() {
  try {
    ...
    const isItsNetwork = isp.toLowerCase().includes(atob('aW5zdGl0dXQgdGVrbm9sb2dpIHNlcHVsdWggbm9wZW1iZXI=')) || 
                         org.toLowerCase().includes(atob('aW5zdGl0dXQgdGVrbm9sb2dpIHNlcHVsdWggbm9wZW1iZXI='));
