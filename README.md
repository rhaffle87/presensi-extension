...
- ITS campus Wi-Fi (you'll get a `10.x.x.x` IP automatically)
- Or an ITS VPN (if provided by the university)
...
## Campus Coordinate Presets (ITS Sukolilo)

| Location | Latitude | Longitude |
|----------|----------|-----------|
| Tower 2 | -7.2852792 | 112.7952975 |
| Tower 1 | -7.2849915 | 112.793897 |
| Koridor C | -7.2847939 | 112.7957067 |
